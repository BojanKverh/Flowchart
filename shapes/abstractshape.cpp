...
void AbstractShape::drawIn(QPainter& P, double f)
{
  ...
  P.drawRect(pt.x() - m_cConnectorSize / 2, pt.y() - m_cConnectorSize / 2, m_cConnectorSize,
             m_cConnectorSize);
  P.restore();
}
...
void AbstractShape::drawSelection(QPainter& P, double f)
{
  ...
  P.drawRect(rect.left() - m_cSelectionSize, rect.top() - m_cSelectionSize, m_cSelectionSize,
             m_cSelectionSize);
