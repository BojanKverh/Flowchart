...
{
public:
  enum class Error { eNone = 0, eStartExists = 1, eEndExists = 2 };
...
public:
  ...
  /**
   * @brief findShape Returns index of the given shape. If no such shape can be found, it will
   * return -1
  ...
  /**
   * @brief addShape Tries to append a new shape. This method is supposed to be called by QUndoStack
   * only
   * @param shape Pointer to the shape
  ...
  /**
   * @brief removeShape Removes the i-th shape. This method is supposed to be called by QUndoStack
   * only
   * @param i Shape index
   */
  void removeShape(int i);
  /**
   * @brief selectShape Selects the n-th shape and deselects all the others. This method is supposed
   * to be called by QUndoStack only
   * @param n Shape index
   */
  ...
  /**
   * @brief addConnection Tries to append a new connection. This method is supposed to be called by
   * QUndoStack only
  ...
  /**
   * @brief removeConnection Removes the i-th connection. This method is supposed to be called by
   * QUndoStack only
   * @param i Connection index
   */
  void removeConnection(int i);
  /**
   * @brief selectConnection Selects the n-th connection and deselects all the others. This method
   * is supposed to be called by QUndoStack only
   * @param n Connection index
   */
  void selectConnection(int n);
  /**
   * @brief moveSelected Moves the selected shapes by given point. This method is supposed to be
