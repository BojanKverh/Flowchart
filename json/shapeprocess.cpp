...
data::AbstractShape* ShapeProcess::fromJson(const QJsonObject& obj) const
{
  ...
  switch (type) {
    case data::ShapeType::esIO: shape = new data::ShapeIO; break;
    case data::ShapeType::esProcess: shape = new data::ShapeProcess; break;

    case data::ShapeType::esDecision: shape = new data::ShapeDecision; break;
